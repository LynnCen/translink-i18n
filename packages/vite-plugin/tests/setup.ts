...
// Mock Vite APIs
export const createMockResolvedConfig = (
...
export const createMockViteDevServer = (
...
// Test utilities
export const expectTransformResult = (
  result: any,
...
export const expectVirtualModuleId = (
  id: string,
  prefix = 'virtual:i18n-language-'
) => {
  expect(id).toMatch(
